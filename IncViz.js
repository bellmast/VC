...
function drawNetwork(data) {
    ...
    for(i=0; i < orgNumber; i++) {
        ...
        for(h=i+1; h < orgNumber; h++) {
            ...
            curvePosY = (midY-(midY/5/h))/((h/(i+1)))
            //curvePosY = midY-(midY/2)/h*i
            lineSet.push(paper.path("M"+startingPosX+" "+startingPosY+"Q"+curvePosX+" "+curvePosY+" "+endingPosX+" "+endingPosY).attr({"stroke-width": ".5", "stroke":"90-#FFFFFF-#000000"}))
        }        
    }
}
