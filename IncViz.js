            ...
            if(change=="No" && origin == i && origin!=3) {
                ...
                for (x = 0; x < masterLength; x++) {
                    if (originX == masterxArray[x] && originY == masteryArray[x]) {
                        ...
                        if (layer%2 == 1) {
                            originX += ((ourRadius*radiusModifier*1.5)*Math.cos((Math.PI/180)*(60*(masterCirclePacking%6)+(30*(layer-1)))))
                            originY += ((ourRadius*radiusModifier*1.5)*Math.sin((Math.PI/180)*(60*(masterCirclePacking%6)+(30*(layer-1)))))
